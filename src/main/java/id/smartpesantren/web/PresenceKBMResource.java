...
public class PresenceKBMResource {
    ...
    public List<PresenceSubjectStudentDTO> findDetailStudentsByScheduleId(@PathVariable("id") String id) {
        return presenceKBMStudentRepository.findDetailStudentsByScheduleId(id);
    }
}
