...
import id.smartpesantren.service.dto.PasswordChangeDTO;
import id.smartpesantren.service.dto.UserDTO;
import id.smartpesantren.web.rest.errors.EmailAlreadyUsedException;
import id.smartpesantren.web.rest.errors.EmailNotFoundException;
...
import id.smartpesantren.web.rest.vm.KeyAndPasswordVM;
import id.smartpesantren.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    @PutMapping(path = "/account/reset-password/{id}")
    @Timed
    public void resetDefaultPassword(@PathVariable String id) {
